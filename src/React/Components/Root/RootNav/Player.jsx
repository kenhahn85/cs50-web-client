      ...
      <div className="Player row">
        <div className="col-sm-12">
          <div className="row margin-bottom-10">
            <div className="col-sm-12">
              <i ref="backButton" onClick={this.onBack} className="fa fa-2x fa-backward"></i>
              <i ref="playPauseButton" onClick={this.onPlayPause} className="fa fa-2x fa-play"></i>
              <i ref="forwardButton" onClick={this.onForward} className="fa fa-2x fa-forward"></i>
              <i ref="thumbsUpButton" onClick={this.onThumbsUp} className="fa fa-2x fa-thumbs-up"></i>
              <i ref="thumbsDownButton" onClick={this.onThumbsDown} className="fa fa-2x fa-thumbs-down"></i>
            </div>
          </div>
          <div className="row margin-bottom-10">
            <div className="col-sm-12">
              <span className="songInfo" ref="songInfo"></span>
            </div>
          </div>

          <div className="row lowerPlayer">
            <div className="col-sm-10">
              <ProgressBar initialProgress={0} onProgressChange={this.onTrackProgressChange} componentClass={"TrackBar"} textClassNames={"absoluteRight"} />
            </div>
            <div className="col-sm-2">
              <ProgressBar initialProgress={50} onProgressChange={this.onVolumeProgressChange} componentClass={"VolumeBar"} >
