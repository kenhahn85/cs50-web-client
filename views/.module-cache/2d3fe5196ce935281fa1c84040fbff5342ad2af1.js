        ...
        React.createElement("div", {className: "col-sm-12"}, 
          ...
          React.createElement("div", {className: "row lowerPlayer"}, 
            React.createElement("div", {className: "col-sm-10"}, 
              React.createElement(ProgressBar, {initialProgress: this.state.playerProgressPct, onProgressChange: this.onTrackProgressChange, componentClass: "TrackBar", textClassNames: "absoluteRight"})
            ), 
...
//      console.log('changing track');
    ...
    this.scplayer.on('scplayer.track.whileplaying', function(e, percent) {
      ...
      self.state.playerProgressPct = percent;
    });
