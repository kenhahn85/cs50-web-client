...
module.exports = React.createClass({displayName: 'exports',
      ...
      React.createElement("div", {className: this.props.componentClass}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-sm-12"}, 
            React.createElement("div", {className: "progress ellipsis bold textShadow pointer relative", onMouseDown: this.startProgressChange, style: this.innerState.outerStyle}, 
              ...
              React.createElement("span", {ref: "text", className: this.props.textClassNames})
            )
          )
        )
      )
  ...
  getInitialState: function() {
    console.log('this.props.initialProgress', this.props.initialProgress);
    return {
