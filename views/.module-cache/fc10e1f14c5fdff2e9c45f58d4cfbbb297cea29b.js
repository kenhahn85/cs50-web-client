...
module.exports = React.createClass({displayName: 'exports',
  ...
  onStateUpdate: function() {
    ...
    console.log('current', self.getCurrentSong());
...
//      console.log('changing track');
  ...
  onThumbsUp: function() {
    ...
    $.ajax({
      url: API_SERVER + "/upvote/" + title,
      method: 'post'
    })
      .success(function() {
        Global.currentUser.get('voteMap')[title] = true;
        self.onStateUpdate();
      })
      .fail(function() {
