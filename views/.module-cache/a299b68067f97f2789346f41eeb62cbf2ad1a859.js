...
module.exports = React.createClass({displayName: 'exports',
  ...
  componentWillMount: function() {
    ...
    PubSub.subscribe("PLAYER.PROGRESS_UPDATE." + this.props.componentClass, function (pct) {
      $(this.refs.progressBar.getDOMNode())
        .css('width', pct + "%")
        .attr('aria-valuenow', pct);
    }.bind(this));

    PubSub.subscribe("PLAYER.TEXT_UPDATE." + this.props.componentClass, function (text) {
