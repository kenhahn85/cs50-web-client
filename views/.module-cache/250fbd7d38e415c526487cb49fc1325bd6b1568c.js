...
module.exports = React.createClass({displayName: 'exports',
        ...
        React.createElement("div", {className: "col-sm-12"}, 
          ...
          React.createElement("div", {className: "row lowerPlayer"}, 
            React.createElement("div", {className: "col-sm-10"}, 
              React.createElement(ProgressBar, {initialProgress: 0, onProgressChange: this.onTrackProgressChange, registerProgressUpdater: this.registerProgressUpdater, componentClass: "TrackBar"})
            ), 
  ...
  registerProgressUpdater: function(fn) {
    this.progressUpdater = fn;
  },
