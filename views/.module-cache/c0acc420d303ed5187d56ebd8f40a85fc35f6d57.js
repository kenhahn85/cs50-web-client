...
module.exports = React.createClass({displayName: 'exports',
          ...
          React.createElement("div", {className: "modal-content"}, 
            ...
            React.createElement("div", {className: "modal-body"}, 
              React.createElement("div", {className: "input-group margin-bottom-sm"}, 
                ...
                React.createElement("input", {ref: "username", name: "username", className: "form-control", type: "text", placeholder: "Username"})
              ), 
              React.createElement("div", {className: "input-group"}, 
                React.createElement("span", {className: "input-group-addon"}, React.createElement("i", {className: "fa fa-key fa-fw"})), 
                React.createElement("input", {ref: "password", name: "password", className: "form-control", type: "password", placeholder: "Password"})
              )
            ), 
  ...
  attemptLogin: function(e) {
    var data = {};
    $(this.refs.loginForm.getDOMNode()).serializeArray().forEach(function(x){ data[x.name] = x.value;});
