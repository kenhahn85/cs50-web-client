...
module.exports = React.createClass({displayName: 'exports',
  ...
  checkForwardBackButton: function() {
    var self = this;
    console.log("Global", Global.currentIdx, Global.songs.length);
  ...
  canThumbsUp: function() {
    ...
    console.log('curr song', this.getCurrentSong());
    var currentVote = Global.currentUser.get('voteMap')[this.getCurrentSong().title];
