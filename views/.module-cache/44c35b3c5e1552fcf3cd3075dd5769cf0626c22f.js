...
module.exports = React.createClass({displayName: 'exports',
  ...
  componentWillMount: function() {
    ...
    if (this.props.registerProgressUpdater) {
      this.props.registerProgressUpdater(this.props.componentClass, function(pct) {
        console.log("PCT", pct);
    ...
    if (this.props.registerTextUpdater) {
      this.props.registerTextUpdater(this.props.componentClass, function(text) {
